      ...
      body: SingleChildScrollView(
        child:Container(
          ...
          child:Column(
            children:[
              Container(
                margin:EdgeInsets.only(top: screenHeight/15, left:screenWidth/20, right:screenWidth/20),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Container(
                      margin:EdgeInsets.only(right:screenWidth/100),
                      child:Text("ROCKET LEAGUE CHECKER", style:GoogleFonts.hind(
              ...
              Container(
                ...
                child: TextButton(
                  ...
                  child:Text("Check your Epic ID", style:GoogleFonts.hind(
                    fontWeight:FontWeight.bold,
                    color:Colors.white
                  ))
                ),
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  child:Text("SEARCH", style:GoogleFonts.hind(
                    fontWeight:FontWeight.bold,
